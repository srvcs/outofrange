...
pub struct Config {
    ...
    /// Base URL of the srvcs-between dependency.
...
impl Config {
    pub fn from_vars(
        ...
        Config {
            ...
            between_url: between_url.unwrap_or_else(|| "http://127.0.0.1:8090".to_string()),
            not_url: not_url.unwrap_or_else(|| "http://127.0.0.1:8091".to_string()),
        }
    }
    ...
    pub fn from_env() -> Self {
        Self::from_vars(
            ...
            std::env::var("SRVCS_BETWEEN_URL").ok(),
...
mod tests {
    ...
    fn defaults_are_sane() {
        ...
        assert_eq!(c.between_url, "http://127.0.0.1:8090");
        assert_eq!(c.not_url, "http://127.0.0.1:8091");
    }
